...
import { FaChevronLeft, FaChevronRight, FaHeart, FaLocationDot, FaBed, FaRuler, FaBath, FaX } from 'react-icons/fa6';
        ...
        <div className='fixed inset-0 bg-black/70 backdrop:blur-md flex items-center justify-center z-50 p-4' onClick={onClose}>
            <div className='relative bg-white rounded-3xl max-w-xl w-full md:max-h-[90vh] overflow-y-auto shadow-2xl' onClick={(e) => e.stopPropagation()}>
                ...
                <div className='p-6'>
                    ...
                    <h2 className='text-2xl font-bold text-gray-800 mb-2'>{currentProperty.location}</h2>
                    ...
                    <div className='flex gap-6 mb-6 p-4 bg-gray-50 rounded-lg'>
                        ...
                        <div className='flex items-center gap-2'>
                            ...
                            <span className='text-gray-600'>{currentProperty.sqft} sqtf</span>
                        </div>
                    </div>

                    <div className="mb-6">
                        <h3 className='font-semibold mb-2'>Descritpion</h3>
